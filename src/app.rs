...
use crate::{
    ...
    os_command::{ExecutorError, PlatformExecutor},
    screen_builder::{ScreenBuilder, ScreenBuilderError},
...
pub fn run_shellshot(args: Args) -> Result<(), ShellshotError> {
    ...
    let image_data = ImageRenderer::render_image(&screen, window_decoration)?;
